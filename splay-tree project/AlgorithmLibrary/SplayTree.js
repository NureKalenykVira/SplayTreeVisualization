...
SPLAYTREE.prototype.addControls =  function()
{
	...
	this.insertButton = addControlToAlgorithmBar("Button", "Вставити");
	this.insertButton.onclick = this.insertCallback.bind(this);
	this.deleteField = addControlToAlgorithmBar("Text", "");
	this.deleteField.onkeydown = this.returnSubmit(this.deleteField,  this.deleteCallback.bind(this), 4);
	this.deleteButton = addControlToAlgorithmBar("Button", "Видалити");
	this.deleteButton.onclick = this.deleteCallback.bind(this);
	this.findField = addControlToAlgorithmBar("Text", "");
	this.findField.onkeydown = this.returnSubmit(this.findField,  this.findCallback.bind(this), 4);
	this.findButton = addControlToAlgorithmBar("Button", "Знайти");
	this.findButton.onclick = this.findCallback.bind(this);
	this.printButton = addControlToAlgorithmBar("Button", "Масив");
	this.printButton.onclick = this.printCallback.bind(this);
	this.exampleButton = addControlToAlgorithmBar("Button", "Про алгоритм");
	this.exampleButton.onclick = this.exampleCallback.bind(this);
	this.helpButton = addControlToAlgorithmBar("Button", "Допомога");
	this.helpButton.onclick = this.helpCallback.bind(this);
}

SPLAYTREE.prototype.exampleCallback = function() {
    window.open('algorithm.html', '_blank');
}

SPLAYTREE.prototype.helpCallback = function() {

...
function initCanvas()
{
	...
	skipBackButton = addControlToAnimationBar("Button", "Назад");
	skipBackButton.onclick = animationManager.skipBack.bind(animationManager);
	stepBackButton = addControlToAnimationBar("Button", "Назад на крок");
	...
	stepForwardButton = addControlToAnimationBar("Button", "Вперед на крок");
	stepForwardButton.onclick = animationManager.step.bind(animationManager) ;
	skipForwardButton = addControlToAnimationBar("Button", "Пропустити");
	...
	var txtNode = document.createTextNode("Швидкість анімації"); 
	midLevel.appendChild(bottomLevel);
